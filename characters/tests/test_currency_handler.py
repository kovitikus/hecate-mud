...
class TestCurrency(HecateTest):
    ...
    def test_return_all_coin_types(self):
        plat, gold, silver, copper = self.char1.currency.return_all_coin_types(coin_dict=self.coin_dict1)
    ...
    def test_all_coin_types_to_string(self):
        ...
        result_str = self.char1.currency.all_coin_types_to_string(self.coin_dict1)
    ...
    def test_balance_coin_dict(self):
        ...
        result_coin_dict = self.char1.currency.balance_coin_dict(unbalanced_coin_dict)
    ...
    def test_convert_coin_type(self):
        ...
        plat_result = self.char1.currency.convert_coin_type(plat=plat, gold=gold, silver=silver,
            copper=copper, result_type='plat')
        self.assertEqual(2.002002002, plat_result)

        gold_result = self.char1.currency.convert_coin_type(plat=plat, gold=gold, silver=silver,
            copper=copper, result_type='gold')
        self.assertEqual(2_002.002002, gold_result)

        silver_result = self.char1.currency.convert_coin_type(plat=plat, gold=gold, silver=silver,
            copper=copper, result_type='silver')
        self.assertEqual(2_002_002.002, silver_result)

        copper_result = self.char1.currency.convert_coin_type(plat=plat, gold=gold, silver=silver,
            copper=copper)
    ...
    def test_create_coin_dict(self):
        ...
        result_dict = self.char1.currency.create_coin_dict(plat=plat, gold=gold, silver=silver,
            copper=copper)
    ...
    def test_coin_dict_to_copper(self):
        ...
        copper_result = self.char1.currency.coin_dict_to_copper(coin_dict)
        self.assertEqual(2_002_002_002, copper_result)

    def test_copper_to_coin_dict(self):
        copper = 2_002_002_002

        result_dict = self.char1.currency.copper_to_coin_dict(copper)
