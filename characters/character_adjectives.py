character_adjectives = {
    'Figure': {
        ...
        'Build':
            ['ample', 'athletic', 'average', 'blubbery', 'bony', 'brawny', 'broad-shouldered', 'bulky', 
            'burly', 'chiseled', 'chubby', 'coltish', 'corpulent', 'emaciated', 'fat', 'flabby', 'fragile',
    ...
    'Facial': {
        ...
        'Eye Color':
            ['grey', 'light grey', 'steel', 'blue-grey', 'brown', 'umber', 'dark brown', 'honey brown',
            'hazel', 'golden brown', 'amber', 'green', 'pale green', 'light green', 'pale blue', 'light blue',
            'sea green', 'blue', 'milky white'],
        'Nose':
            ['large', 'hooked', 'pointed', 'pug', 'thin', 'crooked', 'broad', 'bulbous', 'prominent', 'button',
            'aquiline', 'ordinary'],
        'Lips':
            ['full', 'pouting', 'thin', 'pursed', 'sneering', 'ordinary'],
        'Chin':
            ['clefted', 'distinguished', 'double', 'ordinary', 'pointed', 'receding', 'rugged', 'square', 'weak'],
        'Skin Color':
