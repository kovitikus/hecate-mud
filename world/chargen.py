...
def appearance(self, raw_string, **kwargs):
    ...
    options = (
    {"key": ("1", "gender"),
    "desc": f"Set your character's gender. Currently: |c{self.ndb._menutree.attr.get('gender')}|n",
    "goto": "gender"},
    {"key": ("2", "height"),
    "desc": f"Set your character's height. Currently: |c{self.ndb._menutree.attr.get('height')}|n",
    "goto": "height"},
    {"key": ("3", "build"),
    "desc": f"Set your character's build. Currently: |c{self.ndb._menutree.attr.get('build')}|n",
    "goto": "build"},
    {"key": ("4", "face"),
    "desc": f"Set your character's face type. Currently: |c{self.ndb._menutree.attr.get('face')}|n",
    "goto": "face"},
    {"key": ("5", "eye"),
    "desc": f"Set your character's eye color. Currently: |c{self.ndb._menutree.attr.get('eye_color')}|n",
    "goto": "eye_color"},
    {"key": ("6", "nose"),
    "desc": f"Set your character's nose. Currently: |c{self.ndb._menutree.attr.get('nose')}|n",
    "goto": "nose"},
    {"key": ("7", "lips"),
    "desc": f"Set your character's lips. Currently: |c{self.ndb._menutree.attr.get('lips')}|n",
    "goto": "lips"},
    {"key": ("8", "chin"),
    "desc": f"Set your character's chin. Currently: |c{self.ndb._menutree.attr.get('chin')}|n",
    "goto": "chin"},
    {"key": ("9", "skin"),
    "desc": f"Set your character's skin color. Currently: |c{self.ndb._menutree.attr.get('skin_color')}|n",
    "goto": "skin_color"},
    {"key": ("10", "hair"),
    "desc": f"Set your character's hair color. Currently: |c{self.ndb._menutree.attr.get('hair_color')}|n",
    "goto": "hair_color"},
    {"key": ("11", "texture"),
    "desc": f"Set your character's hair texture. Currently: |c{self.ndb._menutree.attr.get('texture')}|n",
    "goto": "texture"},
    {"key": ("12", "length"),
    "desc": f"Set your character's hair length. Currently: |c{self.ndb._menutree.attr.get('length')}|n",
    "goto": "length"},
    {"key": ("13", "style"),
    "desc": f"Set your character's hair style. Currently: |c{self.ndb._menutree.attr.get('style')}|n",
    "goto": "style"},
    {"key": ("14", "back", "main"),
